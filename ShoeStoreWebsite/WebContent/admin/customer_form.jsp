	...
	<div align="center">
		...
		<table>		
			...
			<tr>
				...
				<td align="left"><input type="text" id="phone" name="phone" size="45" value="${customer.phoneNumber}"/></td>
			</tr>
			...
			<tr>
				...
				<td align="left"><input type="text" id="zipCode" name="zipCode" size="45" value="${customer.zip}"/></td>
			</tr>
